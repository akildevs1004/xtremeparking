...
class CompanyController extends Controller
{
    ...
    public function updateParkingSettings(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            "guset_vehicles" => "required",
            "guset_vehicles_payment" => "required",
            "parking_gate_close_time" => "required",
            "parking_price_per_hour" => "nullable",

            "parking_exit_buffertime" => "nullable"
