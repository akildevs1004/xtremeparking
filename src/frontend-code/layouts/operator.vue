<template>
  <v-app>
    ...
    <AudioSoundPlay :key="notificationsMenuItems.length" :notificationsMenuItemsCount="notificationsMenuItems.length" />
    ...
    <v-app-bar :color="changeColor" :clipped-left="clipped" fixed app
          ...
          <v-card style="z-index: 9999">
            ...
            <v-card-text style="padding-left: 0px">
              <AlarmPopupAllAlarmEvents :items="notificationAlarmDevicesContent"
                ...
                @closeDialog="closeDialog" :key="popupKey" :alarm_icons="alarm_icons" />
              <!-- <v-row
...
export default {
  ...
  async created() {
    if (
      ...
      this.isDark = localStorage.getItem("isDarkTheme") === "true";
    }
