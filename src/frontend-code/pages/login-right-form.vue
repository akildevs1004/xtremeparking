      ...
      <v-col style="padding: 0px; margin: auto" class="parent-login-body">
        <div class="login-body p-md-5 mx-md111111-4" style="
          ...
          <div style="color: #fff; text-align: left" class="pt-10">
            <v-form style="padding: 20px" ref="form" method="post" v-model="valid" lazy-validation autocomplete="off">
              ...
              <div class="form-outline pt-5">
                ...
                <v-text-field hide-details role="presentation" dense outlined autocomplete="off"
