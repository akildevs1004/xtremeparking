...
class DeviceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validate = [
            ...
            'camera_in_name' => 'nullable|string',
            'camera_out_name' => 'nullable|string',
        ...
        if ($request->filled("editId")) {
            ...
            try {
                ...
                $model->where("id", "!=", $request->editId)->where("serial_number", $request->serial_number);;



                if ($model->exists()) {
                    return $this->response('Device Serial Number is already exist ', null, false);
                }
                if (!$model->exists()) {
                    ...
                    if ($record) {
                        ...
                        return $this->response('Device cannot Updated.', null, 'device_api_error');
                    }
                } else {
                ...
                return $this->response('Error', null, 'Exception Error' . $th->getMessage());
            }
        } else {
