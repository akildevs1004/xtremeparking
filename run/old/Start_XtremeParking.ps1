...
$services = @(
    @{
        Name='Local MQTT Service'
        Cwd = 'C:\'
        Cmd ='"C:\Program Files\mosquitto\mosquitto.exe" -c "C:\Program Files\mosquitto\mosquitto.conf" -v'
    ...
    @{
        Name='MQTT QR Background Payment'
        Cwd = $BACKEND
