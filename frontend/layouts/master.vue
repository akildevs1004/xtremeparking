<template>
  <v-app>
    <v-navigation-drawer v-model="drawer" expand-on-hover rail dark :clipped="clipped" fixed app
    ...
    <v-app-bar color="primary" dark :clipped-left="clipped" fixed app>
      ...
      <v-menu nudge-bottom="50" transition="scale-transition" origin="center center" bottom left min-width="150"
