    ...
    <v-dialog v-model="dialogViewStartJob" width="700px">
      <v-card>
        ...
        <v-card-text style="padding-left: 10px; background-color: #e9e9e9">
          <PrimaryContactsInfo v-if="selectedCustomer" :key="key" :customer="selectedCustomer" :ticketId="editId"
            @closeDialogCall="closeDialogProcess()" :ticket="selectedTicket" />
        </v-card-text>
      </v-card>
    </v-dialog>
    ...
    <v-card class="elevation-0 p-2" style="padding: 5px">
      <v-row>
        <v-col cols="8">
            ...
            <v-col cols="12">
              <v-row class="pt-0">
                <v-col>
                  ...
                  <span style="color: #9ba5ca">Created On:
                    {{
              ...
              > -->
                ...
                <v-col cols="12" dense style="
                    height: 250px;
                    border-radius: 10px;
                    border: 1px solid #ddd;
                    overflow-y: scroll;
                  ">
                  <div class="pharagrah-content" v-html="payload_ticket.description"></div>
                </v-col>
              </v-row>
            </v-col>
          </v-row>
          ...
          <v-row v-if="editItem.status == 1" style="background-color: #184780; height: 35px; margin-bottom: 10px">
            <v-col style="padding: 0px; padding-left: 10px; margin: auto">
              <h3 @click="replyTicket = !replyTicket" style="color: #fff; cursor: pointer">
          ...
          <v-row v-if="replyTicket">
            <v-col>
              <ReplyToTicket :key="key" :editId="editItem.id" :editItem="editItem" :ticketId="editItem.id"
                :messageReply="true" :editorHeight="200" @close_dialog="ReloadTicketsList()" />
            </v-col>
          </v-row>
          ...
          <v-row v-if="editItem.responses.length > 0" style="
              border: 1px solid #ddd;
              border-radius: 10px;
              border-radius: 0px 0px 10px 10px;
            ">
            <v-col>
              <v-row style="margin-bottom: 10px; border-top: 1px solid #ddd" v-for="(item, i) in editItem.responses"
                :key="i">
                <v-col>
                  <v-row>
                    <v-col style="max-width: 100px"><v-img style="
                          width: 50px;
                          max-height: 50px;
                    ...
                    <v-col>
                      ...
                      ">
                        (Me)
                        <v-chip color="#f9c9d2" style="height: 20px" label pill>Customer</v-chip>
                      </div>
                      ...
                      ">
                        <v-chip color="#f9c9d2" style="height: 20px" label pill>(Me)Operator</v-chip>
                      </div>

                      <div v-else-if="item.security">
                        {{ item.security.first_name }}
                        {{ item.security.last_name }}
                        <v-chip color="#f9c9d2" style="height: 20px" label pill>Operator</v-chip>
                      </div>
                      ...
                      <div v-else-if="item.technician">
                        ...
                        <v-chip color="#f9c9d2" style="height: 20px" label pill>Technician</v-chip>
                      </div>
                      <div v-else>
                        Admin
                  ...
                  <v-row class="mt-0 pt-0">
                    ...
                    <v-col class="mt-0 pt-0">
                      ...
                      <v-row class="mt-0 pt-0" style="text-align: right">
                        <v-col cols="12" v-if="item?.attachments?.length > 0" style="text-align: right">
                          <v-icon>mdi-paperclip</v-icon>{{ item?.attachments?.length ?? 0 }})
        ...
        <v-col cols="4">
              ...
              <v-row style="border-bottom: 1px solid #ddd">
                ...
                <v-col>
                  ...
                  <div v-else-if="
                    ...
                    editItem.job_start_datetime != null
                  ">
                    <div label color="#a2b117" style="width: 60px; color: #a2b117">
                      Process
                    </div>
                  </div>
                  <div v-else-if="
                  ...
                  ">
                    <div label color="#1e71c3" style="width: 60px; color: #1e71c3">
                      Open
                    </div>
                  </div>
                  <div v-else-if="
          ...
          <v-row style="border: 1px solid #ddd; border-radius: 10px" class="mt-5">
            <v-col cols="12" v-if="selectedCustomer">
              ...
              <v-row class="mt-0 pa-0">
                <v-col>
                  <v-card style=""><v-card-text elevation="2">
                      <v-row>
          ...
          <v-row style="border: 1px solid #ddd; border-radius: 10px" class="mt-5">
            <v-col cols="12" v-if="selectedCustomer">
              ...
              <v-row class="mt-0 pa-0">
                <v-col>
                  <v-card><v-card-text elevation="2">
